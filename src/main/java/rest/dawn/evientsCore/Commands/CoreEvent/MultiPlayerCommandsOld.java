...
public class MultiPlayerCommandsOld implements CommandExecutor {
    EvientsCore plugin;
    public static String selectorRegex = "(all|alive|dead|random|randomalive|randomdead)$";

    public MultiPlayerCommandsOld(EvientsCore plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String[] strings) {
        ...
        if (!plugin.permissions.ensurePermission(commandSender, "")) {
            return true;
        }
